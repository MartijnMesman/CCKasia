              ...
              {isMainExercise && (
                <div className="ml-10 mt-6">
                  ...
                  <div className="p-4 bg-blue-900/20 border border-blue-500/30 rounded-lg">
                      ...
                      </div>  <AudioPlayer src="/audio/mindwondering-online_compressed.mp3" />
              
              <a
                href="https://github.com/MartijnMesman/CCKasia/raw/a73d5ea485271476da56ef742f70e7c1d326343f/mindwondering-online_compressed.mp3"
                download="mindwondering-online_compressed.mp3"
                className="inline-flex items-center justify-center px-4 py-2 mt-4 bg-gray-700 hover:bg-gray-600 text-white rounded-lg transition-colors duration-200 text-sm"
              >
                <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                Download GitHub Audio
              </a>
                      <div>
